...
__all__ = ['ptm_shape_dict', 'get_plot_data', 'plot_single_peptide_traces', 'uniprot_feature_dict',
           'uniprot_feature_dict_rev', 'uniprot_color_dict', 'plot_peptide_traces']
...
# Cell
uniprot_color_dict = {'CHAIN': 'crimson',
                      'INIT_MET': 'crimson',
                      'PEPTIDE': 'crimson',
                      'PROPEP': 'crimson',
                      'SIGNAL': 'crimson',
...
def plot_peptide_traces(df,name,protein,fasta,uniprot,selected_features,
                        uniprot_feature_dict_rev,uniprot_color_dict):
