...
pip install "../../dist/alphamap-0.0.6-py3-none-any.whl"
conda list
...
if false; then
  ...
  pkgbuild --root dist/alphamap --identifier de.mpg.biochem.alphamap.app --version 0.0.6 --install-location /Applications/AlphaMap.app --scripts scripts alphamap.pkg --sign "Developer ID Installer: Max-Planck-Gesellschaft zur Förderung der Wissenschaften e.V. (7QSY5527AQ)"
  ...
  pkgbuild --root dist/alphamap --identifier de.mpg.biochem.alphamap.app --version 0.0.6 --install-location /Applications/AlphaMap.app --scripts scripts alphamap.pkg
