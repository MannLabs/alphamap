...
pkgbuild --root dist/alphamap --identifier de.mpg.biochem.alphamap.app --version 0.1.13 --install-location /Applications/AlphaMap.app --scripts scripts alphamap.pkg
